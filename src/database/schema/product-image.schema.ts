import { pgTable, bigint, varchar, boolean, integer } from "drizzle-orm/pg-core";
...
export const productImages = pgTable('product_images', {
    ...
    optionId: bigint('option_id', { mode: 'number' }).references(() => productOptions.id, { onDelete: 'set null' })
});
