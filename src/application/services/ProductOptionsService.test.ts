...
describe("ProductOptionsService", () => {
  ...
  describe("addOptions", () => {
    it("새로운 옵션을 생성하고 저장", async () => {
      ...
      const result = await service.addOptions(id, option_group_id, optionData);
  ...
  describe("updateOptions", () => {
    it("기존 옵션을 찾아 병합하고 저장", async () => {
      ...
      const result = await service.updateOptions(id, option_id, updateData);
  ...
  describe("deleteOptions", () => {
    it("옵션 삭제", async () => {
      ...
      await service.deleteOptions(id, option_id);
  ...
  describe("addImages", () => {
    it("이미지를 저장", async () => {
      ...
      const result = await service.addImages(id, option_id, imageData);
