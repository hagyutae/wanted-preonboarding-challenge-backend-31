...
public class ReviewMapper {
    ...
    public ReviewListResponse toListResponse(Page<Review> reviewPage, int page, int perPage, Long productId) {
    ...
    public ReviewListResponse.ReviewSummary calculateReviewSummary(
            Page<Review> reviewPage, Long productId, Double averageRating, Integer totalCount, List<Object[]> ratingDistribution) {
